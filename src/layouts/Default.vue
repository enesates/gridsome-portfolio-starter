    ...
    <footer class="bg-gray-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-6">
        <div class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. Tüm hakları saklıdır.</div>
          <div>Altyapı: 
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="https://github.com/enesates" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/enesatesimov" target="_blank" class="text-white hover:text-gray-400">
